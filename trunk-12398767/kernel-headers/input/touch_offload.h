...
#define TOUCH_OFFLOAD_DATA_SIZE_2D(heatmap_height,heatmap_width) (sizeof(__u16) * (heatmap_height) * (heatmap_width))
#define TOUCH_OFFLOAD_FRAME_SIZE_2D(heatmap_height,heatmap_width) (sizeof(struct TouchOffloadData2d) - 1 + TOUCH_OFFLOAD_DATA_SIZE_2D((heatmap_height), (heatmap_width)))
...
#define TOUCH_OFFLOAD_DATA_SIZE_1D(heatmap_height,heatmap_width) (sizeof(__u16) * ((heatmap_height) + (heatmap_width)))
#define TOUCH_OFFLOAD_FRAME_SIZE_1D(heatmap_height,heatmap_width) (sizeof(struct TouchOffloadData1d) - 1 + TOUCH_OFFLOAD_DATA_SIZE_1D((heatmap_height), (heatmap_width)))
